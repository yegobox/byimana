...
const dbPass = encodeURIComponent('110197,vintage');
const dbUserName = encodeURIComponent('Byimana');
const dbCluster = encodeURIComponent('cluster0.cwy7y.gcp.mongodb.net')
...
mongoose.connect(`mongodb+srv://${dbUserName}:${dbPass}@${dbCluster}/byimanaweb?retryWrites=true&w=majority`, {
    useUnifiedTopology: true,
    useNewUrlParser: true,
    useCreateIndex: true
}).then(() => { console.log('database connection established successfully') });

app.get('/uploadAnnouncements', auth, (req, res) => {
